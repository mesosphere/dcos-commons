...
public final class SerializationUtils {
   ...
   * serializing/de-serializing Protobuf objects.
   */
  private static final ObjectMapper DEFAULT_YAML_MAPPER = registerDefaultModules(
   ...
   * serializing/de-serializing Protobuf objects.
   */
  private static final ObjectMapper DEFAULT_JSON_MAPPER = registerDefaultModules(
      new ObjectMapper());
  ...
  /**
   * Returns a single-line representation of the provided value using the provided custom
   * object mapper.
   */
   ...
   * Returns a representation of the provided value using the provided custom object mapper.
   */
  public static <T> T fromString(String str, Class<T> clazz, ObjectMapper mapper)
      throws IOException
  {
