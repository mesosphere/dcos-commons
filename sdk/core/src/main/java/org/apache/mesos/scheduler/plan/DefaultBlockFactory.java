...
/**
 * This class is a default implementation of the {@link BlockFactory} interface.
 */
public class DefaultBlockFactory implements BlockFactory {
    ...
    public Block getBlock(TaskSpecification taskSpecification) throws Block.InvalidBlockException {
        ...
        } catch (InvalidRequirementException | InvalidProtocolBufferException | TaskException e) {
