...
```bash
$ curl -H "Authorization:token=" <dcos_url>/service/elastic/v1/plans/deploy
```
## Pause Installation
...
```bash
$ curl -X POST -H "Authorization:token=" <dcos_url>/service/elastic/v1/plans/deploy/interrupt
```
...
HTTP Example
```
$ curl  -H "Authorization:token=" <dcos_url>/service/elastic/v1/pod
```
...
```
$ curl  -H "Authorization:token=" <dcos_url>/service/elastic/v1/pod/<node-id>/info
```
...
HTTP Example
```
$ curl  -H "Authorization:token=" <dcos_url>/service/elastic/v1/pod/journalnode-0/info
...
HTTP Example
```
$ curl -X POST -H "Authorization:token=" <dcos_url>/service/elastic/v1/pod/<node-id>/replace
```
...
HTTP Example
```bash
$ curl -X POST -H "Authorization:token=" <dcos_url>/service/elastic/v1/pod/<node-id>/restart
```
...
HTTP Example
```
$ curl -H "Authorization:token=" <dcos_url>/service/elastic/v1/configurations/target
```
...
HTTP Example
```
$ curl -H "Authorization:token=" <dcos_url>/service/elastic/v1/configurations
```
...
HTTP Example
```
$ curl -H "Authorization:token=" <dcos_url>/service/elastic/v1/configurations/9a8d4308-ab9d-4121-b460-696ec3368ad6
```
...
```
curl -H "Authorization: token=" "<dcos_url>/service/elastic/v1/state/properties/suppressed"
