...
public class ElasticServiceTest extends BaseServiceSpecTest {
    ...
    public ElasticServiceTest() {
        super(
                ...
                "ELASTICSEARCH_JAVA_URI", "http://elastic-java.uri",
                "SCHEDULER_URI", "http://scheduler.uri",
                "ELASTICSEARCH_URI", "http://elastic-search.uri",
                "XPACK_URI", "http://xpack.uri",
                "DIAGNOSTICS_URI", "http://diagnostics.uri",
                "STATSD_URI", "http://statsd.uri",
                "PORT_API", "8080",
