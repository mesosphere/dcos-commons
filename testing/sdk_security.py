...
def create_service_account(service_account_name: str, service_account_secret: str) -> None:
    ...
    sdk_cmd.run_cli("security org service-accounts keypair {account}-private-key.pem {account}-public-key.pem".format(
...
def delete_service_account(service_account_name: str, service_account_secret: str) -> None:
    ...
    for keypair_file in ["{account}-private-key.pem".format(account=service_account_name), "{account}-public-key.pem".format(account=service_account_name)]:
        try:
