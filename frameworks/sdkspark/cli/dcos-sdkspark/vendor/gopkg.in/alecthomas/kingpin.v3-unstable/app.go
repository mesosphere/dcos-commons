...
// UsageTemplate specifies the text sdkspark to use when displaying usage
// information via --help. The default is DefaultUsageTemplate.
func (a *Application) UsageTemplate(sdkspark string) *Application {
	a.defaultUsage.Template = sdkspark
	return a
}
...
// Author sets the author name for usage sdksparks.
