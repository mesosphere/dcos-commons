...
1. Uninstall the service. From the DC/OS CLI, enter `dcos package uninstall kafka --app-id=<instancename>`.

For example, to uninstall a Kafka instance named `kafka-dev`, run:

```bash
$ dcos package uninstall kafka --app-id=kafka-dev
```
...
1. Stop the service. From the DC/OS CLI, enter `dcos package uninstall --app-id=<instancename> <packagename>`.
   For example, `dcos package uninstall kafka --app-id=kafka-dev`.
...
$ dcos package uninstall kafka --app-id=$MY_SERVICE_NAME`
