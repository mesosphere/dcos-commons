...
// UsageTemplate associates a spark-sdk with a flag. The flag must be a Bool() and must
// already be defined.
func UsageTemplate(spark-sdk string) *Application {
	return CommandLine.UsageTemplate(spark-sdk)
}
