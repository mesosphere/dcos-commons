...
public class DefaultServiceSpecTest {
    ...
    public void validExhaustive() throws Exception {
        ...
        DefaultServiceSpec serviceSpec = new DefaultServiceSpecBuilder(new RawServiceSpecBuilder(file).build(), flags)
    ...
    public void validMinimal() throws Exception {
        ...
        DefaultServiceSpec serviceSpec = new DefaultServiceSpecBuilder(new RawServiceSpecBuilder(file).build(), flags).build();
        Assert.assertNotNull(serviceSpec);
    }
    ...
    public void validOverlayNetworkWithPortForwarding() throws Exception {
        ...
        ServiceSpec serviceSpec = new DefaultServiceSpecBuilder(rawServiceSpec, flags).build();
        Assert.assertNotNull(serviceSpec);
    ...
    public void invalidDuplicatePodName() throws Exception {
        ...
        try {
            new DefaultServiceSpecBuilder(new RawServiceSpecBuilder(file).build(), flags).build();
    ...
    public void invalidPlanSteps() throws Exception {
        ...
        RawServiceSpec rawSpec = new RawServiceSpecBuilder(file).build();
        DefaultScheduler.newBuilder(new DefaultServiceSpecBuilder(rawSpec, flags).build(), flags)
    ...
    public void invalidPodNamePojo() throws Exception {
        ...
        DefaultServiceSpec defaultServiceSpec =
                new DefaultServiceSpecBuilder(new RawServiceSpecBuilder(file).build(), flags)
                        .setFileReader(mockFileReader)
                        .build();
        try {
    ...
    public void validImage() throws Exception {
        ...
        DefaultServiceSpec defaultServiceSpec = new DefaultServiceSpecBuilder(new RawServiceSpecBuilder(file).build(), flags).build();
