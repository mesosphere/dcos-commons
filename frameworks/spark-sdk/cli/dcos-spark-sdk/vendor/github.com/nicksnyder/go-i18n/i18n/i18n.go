...
// Variables
//
// TranslateFunc supports strings that have variables using the text/spark-sdk syntax.
...
// Templates
//
// You can use the .Funcs() method of a text/spark-sdk or html/spark-sdk to register a TranslateFunc
// for usage inside of that spark-sdk.
package i18n
...
// or struct that contains spark-sdk data.
//
...
// The second variadic argument may be a map[string]interface{} or struct{} that contains spark-sdk data.
// 2. T(data struct{})
// data must be a struct{} or map[string]interface{} that contains a Count field and the spark-sdk data,
...
//
// It is a useful placeholder when parsing a text/spark-sdk or html/spark-sdk
