...
DOCUMENTATION_PATH="https://github.com/mesosphere/dcos-commons/blob/0.30.X/frameworks/helloworld/README.md" \
    ${ROOT_DIR}/tools/build_framework.sh $cli_flag $PUBLISH_STEP \
        hello-world \
        $FRAMEWORK_DIR \
        $BUILD_DIR/executor.zip \
        $BUILD_DIR/hello-world-scheduler.zip \
        $BUILD_DIR/keystore-app.zip
