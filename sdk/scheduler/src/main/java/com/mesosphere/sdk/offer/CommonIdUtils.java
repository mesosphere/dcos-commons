 ...
 */
public final class CommonIdUtils {
  ...
  private static final Protos.TaskID EMPTY_TASK_ID =
      Protos.TaskID.newBuilder().setValue("").build();

  private static final Protos.SlaveID EMPTY_AGENT_ID =
   ...
   */
  public static Optional<String> toSanitizedServiceName(
  ...
  public static String toSanitizedServiceName(String serviceName) {
    ...
    return StringUtils
        .strip(serviceName, SANITIZE_ID_FROM)
        .replace(SANITIZE_ID_FROM, SANITIZE_ID_TO);
  }
   ...
   */
  public static Protos.TaskID toTaskId(
      String serviceName,
      String taskName)
   ...
   */
  private static String toIdString(
      String serviceName,
      String itemName)
      throws IllegalArgumentException
  {
    ...
    return toSanitizedServiceName(serviceName) +
        NAME_ID_DELIM +
        itemName +
        NAME_ID_DELIM +
        UUID.randomUUID();
  ...
  private static String extract(String id, boolean serviceName) throws TaskException {
    ...
    int secondLastDelimIndex = id.lastIndexOf(
        NAME_ID_DELIM,
        lastDelimIndex - NAME_ID_DELIM.length()
    );
