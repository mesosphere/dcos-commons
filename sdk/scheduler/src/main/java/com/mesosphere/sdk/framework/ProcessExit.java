...
/**
 * This class handles exiting the Scheduler process, after completed teardown or after a
 * fatal error.
 */
public final class ProcessExit {
  ...
  public static final Code SCHEDULER_ALREADY_UNINSTALLING =
      new Code(11, "SCHEDULER_ALREADY_UNINSTALLING");
  ...
  /**
   * Similar to {@link #exit(ProcessExit)}, except also prints the stack trace of the provided
   * exception before exiting the process. This may be used in contexts where the process is
   * exiting in response to a thrown exception.
   */
