...
public class StrategyFactoryTest {
    ...
    public void testParallelStep() {
        Assert.assertTrue(
                StrategyFactory.generateForSteps("parallel", Collections.emptyList()) instanceof ParallelStrategy);
    }

    @Test
    public void testSerialStep() {
        Assert.assertTrue(
                StrategyFactory.generateForSteps("serial", Collections.emptyList()) instanceof SerialStrategy);
    }
