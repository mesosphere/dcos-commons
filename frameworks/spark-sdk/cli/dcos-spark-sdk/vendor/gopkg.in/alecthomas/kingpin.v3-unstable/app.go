...
// UsageTemplate specifies the text spark-sdk to use when displaying usage
// information via --help. The default is DefaultUsageTemplate.
func (a *Application) UsageTemplate(spark-sdk string) *Application {
	a.defaultUsage.Template = spark-sdk
	return a
}
...
// Author sets the author name for usage spark-sdks.
