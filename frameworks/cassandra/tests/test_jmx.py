...
def test_secure_jmx_configuration(self_signed_trust_store):
    ...
    try:
        ...
        _, output, _ = sdk_cmd.run_cli("task exec {} {}".format(node_task_id_0, full_cmd), print_output=True)
        ...
        full_cmd = "bash -c '{}{}'".format(cmd, input_jmx_commands)
        rc, output, stderr = sdk_cmd.run_cli("task exec {} {}".format(node_task_id_0, full_cmd), print_output=True)
