...
public class DefaultService implements Service {
    ...
    private boolean allButStateStoreUninstalled() {
        // Because we cannot delete the root ZK node (ACLs on the master, see StateStore.clearAllData() for more details)
        // we have to clear everything under it. This results in a race condition, where DefaultService can have register()
        // called after the StateStore already has the uninstall bit wiped.
        //
