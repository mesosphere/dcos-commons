 ...
 */
@Path("/v1/health")
public class MultiHealthResource {
  /**
   ...
   * coordinator.
   */
  public MultiHealthResource(PlanCoordinator planCoordinator, SchedulerConfig schedulerConfig) {
   ...
   */
  public MultiHealthResource(Collection<PlanManager> planManagers,
