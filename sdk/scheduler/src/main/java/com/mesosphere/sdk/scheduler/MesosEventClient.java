...
public interface MesosEventClient {
   ...
   */
  void registered(boolean reRegistered);
   ...
   */
  OfferResponse offers(Collection<Protos.Offer> offers);
   ...
   */
  UnexpectedResourcesResponse getUnexpectedResources(Collection<Protos.Offer> unusedOffers);
   ...
   */
  TaskStatusResponse taskStatus(Protos.TaskStatus status);
   ...
   */
  Collection<Object> getHTTPEndpoints(); // SUPPRESS CHECKSTYLE AbbreviationAsWordInName
   ...
   */
  class UnexpectedResourcesResponse {
     ...
     */
    public static UnexpectedResourcesResponse failed(
        Collection<OfferResources> unexpectedResources)
    {
     ...
     */
    public static UnexpectedResourcesResponse processed(
        Collection<OfferResources> unexpectedResources)
    {
