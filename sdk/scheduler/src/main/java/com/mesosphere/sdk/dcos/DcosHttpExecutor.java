 ...
 * {@link Executor} instance. Clients which interact with the DC/OS cluster should (only) accept
 * this DC/OS-specific type in order to ensure that the validation is performed.
 */
