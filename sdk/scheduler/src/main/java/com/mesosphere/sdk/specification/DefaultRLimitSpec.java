...
public class DefaultRLimitSpec implements RLimitSpec {
    ...
    @JsonIgnore
    public static Protos.RLimitInfo.RLimit.Type getEnum(RLimitSpec spec) {
        return RLIMITS.get(spec.getName());
    }
    ...
    /**
     * An exception for errors pertaining to {@link DefaultRLimitSpec}.
     */
