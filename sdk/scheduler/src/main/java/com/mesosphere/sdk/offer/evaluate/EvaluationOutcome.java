...
/**
 * The outcome of invoking an {@link OfferEvaluationStage}. Describes whether the evaluation passed
 * or failed, and the reason(s) why. Supports a nested tree of outcomes which describe any
 * sub-evaluations which may have been performed within the {@link OfferEvaluationStage}.
 */
public final class EvaluationOutcome {
   ...
   * @param reasonFormat         {@link String#format(String, Object...)} compatible format string describing the pass
   *                                                                    reason
   * @param reasonArgs           format arguments, if any, to apply against {@code reasonFormat}
   */
  public static EvaluationOutcome.Builder pass(
