...
CLI Example
```
$ dcos $packagename pod info journalnode-0
```
...
CLI Example
```
$ dcos $packagename pod replace <node-id>
```
...
CLI Example
```
$ dcos $packagename pod restart <node-id>
```
...
CLI Example
```
$ dcos $packagename config target
```
...
CLI Example
```
$ dcos $packagename config show 9a8d4308-ab9d-4121-b460-696ec3368ad6
```
