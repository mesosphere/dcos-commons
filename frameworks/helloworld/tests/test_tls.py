...
def test_tls_basic_artifacts(hello_world_service):
    ...
    assert common_name in hosts.autoip_host(PACKAGE_NAME, 'artifacts-0-node')
...
def test_changing_discovery_replaces_certificate_sans(hello_world_service):
    ...
    """
    task_id = tasks.get_task_ids(PACKAGE_NAME, "discovery")[0]
    assert task_id
    ...
    new_task_id = tasks.get_task_ids(PACKAGE_NAME, "discovery")[0]
