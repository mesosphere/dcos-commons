 ...
 */
public class CycleDetectingLockUtils {
     ...
     */
    private static final CycleDetectingLockFactory.Policy LOG_AND_EXIT_POLICY = new CycleDetectingLockFactory.Policy() {
        @Override
        public void handlePotentialDeadlock(PotentialDeadlockException e) {
            ProcessExit.exit(ProcessExit.DEADLOCK_ENCOUNTERED, e);
        }
