...
public class IsLocalRegionRule implements PlacementRule {
      ...
      Collection<Protos.TaskInfo> tasks)
  {
    ...
    Protos.DomainInfo.FaultDomain.RegionInfo offerRegion =
        offer.getDomain().getFaultDomain().getRegion();
    Protos.DomainInfo.FaultDomain.RegionInfo localRegion =
        localDomain.getFaultDomain().getRegion();
