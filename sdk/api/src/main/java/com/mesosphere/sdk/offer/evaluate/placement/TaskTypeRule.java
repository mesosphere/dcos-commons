...
public class TaskTypeRule implements PlacementRule {
     ...
     * specified task type.
     */
    private PlacementOutcome filterAvoid(
            Offer offer,
        ...
        return PlacementOutcome.pass(this, "No tasks of avoided type '%s' found on this agent.", typeToFind).build();
    }
     ...
     * type.
     */
    private PlacementOutcome filterColocate(
            Offer offer,
            PodInstance podInstance,
