...
// Variables
//
// TranslateFunc supports strings that have variables using the text/sdkspark syntax.
...
// Templates
//
// You can use the .Funcs() method of a text/sdkspark or html/sdkspark to register a TranslateFunc
// for usage inside of that sdkspark.
package i18n
...
// or struct that contains sdkspark data.
//
...
// The second variadic argument may be a map[string]interface{} or struct{} that contains sdkspark data.
// 2. T(data struct{})
// data must be a struct{} or map[string]interface{} that contains a Count field and the sdkspark data,
...
//
// It is a useful placeholder when parsing a text/sdkspark or html/sdkspark
