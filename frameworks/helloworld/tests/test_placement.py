...
def test_rack_not_found():
    ...
    sdk_install.install(PACKAGE_NAME, SERVICE_NAME, 0, additional_options=options, wait_for_deployment=False)
    try:
        sdk_tasks.check_running(SERVICE_NAME, 1, timeout_seconds=60)
...
def test_hostname_unique():
    ...
    sdk_install.install(PACKAGE_NAME, SERVICE_NAME, num_private_agents * 2, additional_options=options)
    ...
    sdk_tasks.check_running(SERVICE_NAME, num_private_agents * 2 - 1, timeout_seconds=10)
    sdk_tasks.check_running(SERVICE_NAME, num_private_agents * 2)
...
def test_max_per_hostname():
    ...
    sdk_install.install(PACKAGE_NAME, SERVICE_NAME, num_private_agents * 5, additional_options=options)
...
def test_rr_by_hostname():
    ...
    sdk_install.install(PACKAGE_NAME, SERVICE_NAME, num_private_agents * 4, additional_options=options)
...
def test_cluster():
    ...
    sdk_install.install(PACKAGE_NAME, SERVICE_NAME, num_private_agents, additional_options=options)
...
def test_updated_placement_constraints_no_task_change():
    ...
    sdk_tasks.check_tasks_not_updated(SERVICE_NAME, 'hello', old_ids)
...
def test_updated_placement_constraints_restarted_tasks_dont_move():
    ...
    sdk_tasks.check_tasks_updated(SERVICE_NAME, 'hello', old_ids)
