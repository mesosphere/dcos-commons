...
public class CmdExecutor {
  ...
  public CmdExecutor(
      ...
      String kafkaZookeeperUri,
      String kafkaSandboxPath)
  {
  ...
  {
    /**
     e.g. ./kafka-topics.sh --create --zookeeper master.mesos:2181/kafka-0 --topic topic0
  ...
  private List<String> getProducerPerfCommand(
      String topicName,
      int messages,
