...
@pytest.mark.skip(reason="INFINITY-2043")
def test_secrets_basic():
    ...
    sdk_cmd.run_cli('hello-world pods replace hello-0')
    sdk_cmd.run_cli('hello-world pods replace world-0')
...
def test_secrets_update():
    ...
    sdk_cmd.run_cli('hello-world pods restart hello-0')
    sdk_cmd.run_cli('hello-world pods restart world-0')
