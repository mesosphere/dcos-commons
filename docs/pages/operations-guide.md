...
On the other hand, the secret with path `secret-app/instance1/Secret_Path2` can not be accessed by an service with ID `/secret-app` because it is not _under_ this secret's namespace which is `/secret-app/insance1/`. `secret-app/instance1/Secret_Path2` can be accessed by any service with ID under `/secret-app/instance1/`, for example `/secret-app/instance1/app3` or `/secret-app/instance1/someDir/app4`.
