...
public class DefaultVolumeSpecTest {
    ...
    public void testRootVolumeProfiles() {
        new DefaultVolumeSpec(
                DISK_SIZE_MB, VolumeSpec.Type.ROOT, "path", Arrays.asList("test"), "role", "*", "principal");
    }

    @Test(expected = IllegalArgumentException.class)
    public void testRootVolumeEmptyProfiles() {
        new DefaultVolumeSpec(
                DISK_SIZE_MB, VolumeSpec.Type.ROOT, "path", Arrays.asList(), "role", "*", "principal");
    }

    @Test
    public void testPathVolumeNullProfiles() {
        new DefaultVolumeSpec(
                DISK_SIZE_MB, VolumeSpec.Type.PATH, "path", null, "role", "*", "principal");
    }

    @Test(expected = IllegalArgumentException.class)
    public void testPathVolumeProfiles() {
        new DefaultVolumeSpec(
                DISK_SIZE_MB, VolumeSpec.Type.PATH, "path", Arrays.asList("test"), "role", "*", "principal");
    }

    @Test(expected = IllegalArgumentException.class)
    public void testPathVolumeEmptyProfiles() {
        new DefaultVolumeSpec(
                DISK_SIZE_MB, VolumeSpec.Type.PATH, "path", Arrays.asList(), "role", "*", "principal");
    }

    @Test
    public void testMountVolumeNullProfiles() {
        new DefaultVolumeSpec(
                DISK_SIZE_MB, VolumeSpec.Type.MOUNT, "path", null, "role", "*", "principal");
    }

    @Test
    public void testMountVolumeProfiles() {
        new DefaultVolumeSpec(
                DISK_SIZE_MB, VolumeSpec.Type.MOUNT, "path", Arrays.asList("test"), "role", "*", "principal");
    }

    @Test(expected = IllegalArgumentException.class)
    public void testMountVolumeEmptyProfiles() {
        new DefaultVolumeSpec(
                DISK_SIZE_MB, VolumeSpec.Type.MOUNT, "path", Arrays.asList(), "role", "*", "principal");
    }

    @Test(expected = IllegalArgumentException.class)
    public void testMountVolumeProfilesNull() {
        new DefaultVolumeSpec(
                DISK_SIZE_MB, VolumeSpec.Type.MOUNT, "path", Arrays.asList("test", null), "role", "*", "principal");
    }
    ...
    public void testMountVolumeProfilesNumber() {
        new DefaultVolumeSpec(
                DISK_SIZE_MB, VolumeSpec.Type.MOUNT, "path", Arrays.asList("test", "0"), "role", "*", "principal");
    }

    @Test(expected = IllegalArgumentException.class)
    public void testMountVolumeProfilesSlash() {
        new DefaultVolumeSpec(
                DISK_SIZE_MB, VolumeSpec.Type.MOUNT, "path", Arrays.asList("test", "a/b"), "role", "*", "principal");
    }

    @Test
    public void testMountVolumeProfilesValidChars() {
        new DefaultVolumeSpec(
                DISK_SIZE_MB, VolumeSpec.Type.MOUNT, "path", Arrays.asList("test", "_.-"), "role", "*", "principal");
    }
    ...
    public void testMountVolumeProfilesDuplicate() {
        new DefaultVolumeSpec(
                DISK_SIZE_MB, VolumeSpec.Type.MOUNT, "path", Arrays.asList("test", "test"), "role", "*", "principal");
    }
}
