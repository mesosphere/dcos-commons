...
CLI Example
```bash
$ dcos hdfs pod info --name=hdfs journal-0
```
...
CLI Example
```bash
$ dcos hdfs pod --name=hdfs restart <node-id>
```
...
CLI Example
```bash
$ dcos hdfs config --name=hdfs target
```
...
CLI Example
```bash
$ dcos hdfs config --name=hdfs list
```
...
CLI Example
```bash
$ dcos hdfs config --name=hdfs show 9a8d4308-ab9d-4121-b460-696ec3368ad6
```
