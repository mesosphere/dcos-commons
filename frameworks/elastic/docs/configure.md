...
![agent](https://docs.mesosphere.com/1.9/usage/service-guides/elastic/img/private-nodes-by-agent.png)
![vip](https://docs.mesosphere.com/1.9/usage/service-guides/elastic/img/private-node-by-vip.png)
