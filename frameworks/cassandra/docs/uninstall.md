...
1. Uninstall the service. From the DC/OS CLI, enter `dcos package uninstall --app-id=<instancename> cassandra`.

For example, to uninstall a Cassandra instance named `cassandra-dev`, run:

```bash
dcos package uninstall --app-id=cassandra-dev cassandra
```
...
1. Stop the service. From the DC/OS CLI, enter `dcos package uninstall --app-id=<instancename> <packagename>`.
   For example, `dcos package uninstall --app-id=cassandra-dev cassandra`.
