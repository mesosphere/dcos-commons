...
public class Main {
    ...
    public void run() throws Exception {
        final CustomExecutorTaskFactory customExecutorTaskFactory = new CustomExecutorTaskFactory();
        final CustomExecutor customExecutor =
                new CustomExecutor(Executors.newCachedThreadPool(), customExecutorTaskFactory);
