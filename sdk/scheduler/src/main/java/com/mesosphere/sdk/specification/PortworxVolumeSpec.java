...
/**
 * Portworx implementation of {@link DockerVolumeSpec}.
 */
public final class PortworxVolumeSpec implements DockerVolumeSpec {
  /**
  ...
  /**
   * {@code PortworxVolumeSpec} builder static inner class.
   */
      ...
      if (this.driverOptions != null && this.volumeName != null) {
        if (driverOptions.containsKey("name")) {
          throw new IllegalArgumentException(
              "External volume name provided both in driver options and volume name field.");
        }
      }
