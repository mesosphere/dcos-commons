...
public class TaskTypeRuleTest {
    ...
    public void testColocate() {
        ...
        assertTrue(rule.filter(OFFER_1, REQ, TASKS).isPassing());
        assertFalse(rule.filter(OFFER_2, REQ, TASKS).isPassing());
        assertTrue(rule.filter(OFFER_3, REQ, TASKS).isPassing());
    }
    ...
    public void testColocateWithSamePresent() throws InvalidRequirementException {
        ...
        assertFalse(rule.filter(OFFER_1, REQ_WITH_TASK_MATCH_1, TASKS).isPassing());
        assertFalse(rule.filter(OFFER_2, REQ_WITH_TASK_MATCH_1, TASKS).isPassing());
        assertTrue(rule.filter(OFFER_3, REQ_WITH_TASK_MATCH_1, TASKS).isPassing());

        assertTrue(rule.filter(OFFER_1, REQ_WITH_TASK_MATCH_3, TASKS).isPassing());
        assertFalse(rule.filter(OFFER_2, REQ_WITH_TASK_MATCH_3, TASKS).isPassing());
        assertFalse(rule.filter(OFFER_3, REQ_WITH_TASK_MATCH_3, TASKS).isPassing());

        assertTrue(rule.filter(OFFER_1, REQ_WITH_TASK_MISMATCH_1, TASKS).isPassing());
        assertFalse(rule.filter(OFFER_2, REQ_WITH_TASK_MISMATCH_1, TASKS).isPassing());
        assertTrue(rule.filter(OFFER_3, REQ_WITH_TASK_MISMATCH_1, TASKS).isPassing());

        assertTrue(rule.filter(OFFER_1, REQ_WITH_TASK_MISMATCH_2, TASKS).isPassing());
        assertFalse(rule.filter(OFFER_2, REQ_WITH_TASK_MISMATCH_2, TASKS).isPassing());
        assertTrue(rule.filter(OFFER_3, REQ_WITH_TASK_MISMATCH_2, TASKS).isPassing());

        assertTrue(rule.filter(OFFER_1, REQ_WITH_TASK_MISMATCH_3, TASKS).isPassing());
        assertFalse(rule.filter(OFFER_2, REQ_WITH_TASK_MISMATCH_3, TASKS).isPassing());
        assertTrue(rule.filter(OFFER_3, REQ_WITH_TASK_MISMATCH_3, TASKS).isPassing());
    }
    ...
    public void testAvoid() {
        ...
        assertFalse(rule.filter(OFFER_1, REQ, TASKS).isPassing());
        assertTrue(rule.filter(OFFER_2, REQ, TASKS).isPassing());
        assertFalse(rule.filter(OFFER_3, REQ, TASKS).isPassing());
    }
    ...
    public void testAvoidWithSamePresent() throws InvalidRequirementException {
        ...
        assertTrue(rule.filter(OFFER_1, REQ_WITH_TASK_MATCH_1, TASKS).isPassing());
        assertTrue(rule.filter(OFFER_2, REQ_WITH_TASK_MATCH_1, TASKS).isPassing());
        assertFalse(rule.filter(OFFER_3, REQ_WITH_TASK_MATCH_1, TASKS).isPassing());

        assertFalse(rule.filter(OFFER_1, REQ_WITH_TASK_MATCH_3, TASKS).isPassing());
        assertTrue(rule.filter(OFFER_2, REQ_WITH_TASK_MATCH_3, TASKS).isPassing());
        assertTrue(rule.filter(OFFER_3, REQ_WITH_TASK_MATCH_3, TASKS).isPassing());

        assertFalse(rule.filter(OFFER_1, REQ_WITH_TASK_MISMATCH_1, TASKS).isPassing());
        assertTrue(rule.filter(OFFER_2, REQ_WITH_TASK_MISMATCH_1, TASKS).isPassing());
        assertFalse(rule.filter(OFFER_3, REQ_WITH_TASK_MISMATCH_1, TASKS).isPassing());

        assertFalse(rule.filter(OFFER_1, REQ_WITH_TASK_MISMATCH_2, TASKS).isPassing());
        assertTrue(rule.filter(OFFER_2, REQ_WITH_TASK_MISMATCH_2, TASKS).isPassing());
        assertFalse(rule.filter(OFFER_3, REQ_WITH_TASK_MISMATCH_2, TASKS).isPassing());

        assertFalse(rule.filter(OFFER_1, REQ_WITH_TASK_MISMATCH_3, TASKS).isPassing());
        assertTrue(rule.filter(OFFER_2, REQ_WITH_TASK_MISMATCH_3, TASKS).isPassing());
        assertFalse(rule.filter(OFFER_3, REQ_WITH_TASK_MISMATCH_3, TASKS).isPassing());
    }
    ...
    public void testColocateNotFound() {
        ...
        assertTrue(rule.filter(OFFER_1, REQ, MISMATCH_TASKS).isPassing());
        assertTrue(rule.filter(OFFER_2, REQ, MISMATCH_TASKS).isPassing());
        assertTrue(rule.filter(OFFER_3, REQ, MISMATCH_TASKS).isPassing());
    }
