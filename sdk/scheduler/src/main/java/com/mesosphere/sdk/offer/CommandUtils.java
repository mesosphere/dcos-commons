...
/**
 * This class provides utility methods for the construction of {@link com.mesosphere.sdk.Protos.CommandInfo} protobufs
...
public class CommandUtils {
    public static Protos.CommandInfo getCommandInfo(CommandSpec commandSpec) {
        return Protos.CommandInfo.newBuilder()
                ...
                .setEnvironment(CommonTaskUtils.fromMapToEnvironment(commandSpec.getEnvironment()))
