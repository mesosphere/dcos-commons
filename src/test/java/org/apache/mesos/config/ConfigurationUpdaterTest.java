...
public class ConfigurationUpdaterTest {
    ...
    @Test
    public void testOneValidationSuccess() throws ConfigStoreException {
        final TestConfig targetConfig = new TestConfig("a", 1);
    ...
    @Test
    public void testOneValidationEqualConfigs() throws ConfigStoreException {
    ...
    @Test
    public void testOneValidationSameConfig() throws ConfigStoreException {
        // strings are equal, so validation of ints is skipped:
        final TestConfig targetConfig = new TestConfig("a", 1);
    ...
    @Test
    public void testOneValidationSingleError() throws ConfigStoreException {
        final TestConfig targetConfig = new TestConfig("a", 1);
        final TestConfig newConfig = new TestConfig("b", 2);
