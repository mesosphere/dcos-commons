...
var setSuperUserTests = []struct {
	...
	},
	{
		...
		sslAuth:        "true",
		authz:          "true",
		expectedOutput: "User:CN=kafka-0-broker.framework,OU=,O=Mesosphere, Inc,L=San Francisco,ST=CA,C=US",
	},
	{
		...
		authz:          "true",
		superUsers:     "User:evan;User:ben",
		expectedOutput: "User:evan;User:ben;User:CN=kafka-0-broker.framework,OU=,O=Mesosphere, Inc,L=San Francisco,ST=CA,C=US",
	},
}
...
var brokerSuperUserTests = []struct {
	...
	},
	{
		brokerCount:    "2",
		frameworkName:  "framework",
		expectedOutput: "User:CN=kafka-0-broker.framework,OU=,O=Mesosphere, Inc,L=San Francisco,ST=CA,C=US;User:CN=kafka-1-broker.framework,OU=,O=Mesosphere, Inc,L=San Francisco,ST=CA,C=US",
	},
	{
		brokerCount:    "1",
		frameworkName:  "a/long/framework/with/slashes/that/is/very/long/friends/seriously/so/long",
		expectedOutput: "User:CN=er.alongframeworkwithslashesthatisverylongfriendsseriouslysolong,OU=,O=Mesosphere, Inc,L=San Francisco,ST=CA,C=US",
	},
}
