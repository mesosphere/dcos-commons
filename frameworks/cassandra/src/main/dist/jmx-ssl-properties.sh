...
JMX_SECURE_PROPERTIES_FILE=$MESOS_SANDBOX/.ssl/jmxremote.ssl.properties
...
JMX_PROPERTIES_FILE=$MESOS_SANDBOX/.ssl/jmx.properties
...
com.sun.management.jmxremote.password.file=$MESOS_SANDBOX/.ssl/key_file
com.sun.management.jmxremote.access.file=$MESOS_SANDBOX/jmx/access_file
com.sun.management.jmxremote.ssl=true
com.sun.management.jmxremote.ssl.config.file=$MESOS_SANDBOX/.ssl/jmxremote.ssl.properties
