...
// UsageTemplate associates a sdkspark with a flag. The flag must be a Bool() and must
// already be defined.
func UsageTemplate(sdkspark string) *Application {
	return CommandLine.UsageTemplate(sdkspark)
}
