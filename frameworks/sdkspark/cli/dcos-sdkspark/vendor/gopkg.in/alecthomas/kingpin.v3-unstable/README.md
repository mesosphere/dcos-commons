...
- [Reference Documentation](#reference-documentation)
  ...
  - [Custom help](#custom-help)
    ...
    - [Default help sdkspark](#default-help-sdkspark)
    - [Compact help sdkspark](#compact-help-sdkspark)
...
- Fully [customisable help](#custom-help), via Go sdksparks.
...
- Added `UsageForContextWithTemplate()` for printing usage via a custom sdkspark.
- Added `UsageTemplate()` for overriding the default sdkspark to use. Two sdksparks are included:
    1. `DefaultUsageTemplate` - default sdkspark.
    2. `CompactUsageTemplate` - compact command sdkspark for larger applications.
...
- *2015-05-22* -- Stable v2.0.0 release.
    ...
    - Templatised usage help, with default and compact sdksparks.
...
Kingpin supports templatised help using the text/sdkspark library.

You can specify the sdkspark to use with the [Application.UsageTemplate()](http://godoc.org/gopkg.in/alecthomas/kingpin.v2#Application.UsageTemplate) function.

There are four included sdksparks: `kingpin.DefaultUsageTemplate` is the
...
See the above sdksparks for examples of usage, and the the function [UsageForContextWithTemplate()](https://github.com/alecthomas/kingpin/blob/master/usage.go#L198) method for details on the context.
