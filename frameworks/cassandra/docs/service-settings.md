...
*   **In DC/OS CLI options.json**: `service.security.transport_layer.enabled`: boolean (default: `false`)
*   **DC/OS web interface**: `TASKCFG_ALL_SECURITY_TRANSPORT_LAYER_ENABLED`: `boolean`
...
*   **In DC/OS CLI options.json**: `service.security.transport_layer.allow_plaintext`: boolean (default: `false`)
*   **DC/OS web interface**: `TASKCFG_ALL_SECURITY_TRANSPORT_LAYER_ALLOW_PLAINTEXT`: `boolean`
