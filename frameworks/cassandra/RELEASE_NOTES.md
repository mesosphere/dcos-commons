...
```
 $ docs package install  cassandra --options=options.json ` --package-version=<old_package_version_number>
...
```
 $ docs package install  cassandra --options=options.json ` --package-version=<new_package_version_number>
...
```
  $ docs cassandra update start  --options=options.json --package-version=<new_package_version_number>
