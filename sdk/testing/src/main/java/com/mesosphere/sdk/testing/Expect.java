...
public interface Expect extends SimulationTick {
  ...
  public static Expect declinedLastOffer() {
    return new Expect() {
      ...
      public void expect(ClusterState state, SchedulerDriver mockDriver) {
        ...
        Mockito.verify(mockDriver, Mockito.atLeast(lastCycleOfferIds.size())).declineOffer(offerIdCaptor.capture(), any());
  ...
  public static Expect taskNameNotKilled(String taskName) {
    return new Expect() {
      @Override
      public void expect(ClusterState state, SchedulerDriver mockDriver) {
        Mockito.verify(mockDriver, Mockito.never()).killTask(state.getTaskId(taskName));
      }
  ...
  public static Expect reconciledImplicitly() {
    return new Expect() {
      @Override
      public void expect(ClusterState state, SchedulerDriver mockDriver) {
        Mockito.verify(mockDriver, Mockito.atLeastOnce()).reconcileTasks(Collections.emptyList());
      }
  ...
  public static Expect revivedOffers(int totalTimes) {
    return new Expect() {
      @Override
      public void expect(ClusterState state, SchedulerDriver mockDriver) {
        Mockito.verify(mockDriver, Mockito.times(totalTimes)).reviveOffers();
      }
  ...
  public static Expect suppressedOffers(int totalTimes) {
    return new Expect() {
      @Override
      public void expect(ClusterState state, SchedulerDriver mockDriver) {
        Mockito.verify(mockDriver, Mockito.times(totalTimes)).suppressOffers();
      }
