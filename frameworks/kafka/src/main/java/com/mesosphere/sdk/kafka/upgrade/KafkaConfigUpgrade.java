...
public class KafkaConfigUpgrade {
    ...
    /**
     * CuratorStateStoreUpdate
     */
    public static class CuratorStateStoreUpdate extends CuratorStateStore {
        public CuratorStateStoreUpdate(String name, String zk) {
            super(name, zk);
        }
        public void storeStatus(String taskName, Protos.TaskStatus status) throws StateStoreException {
            super.storeStatus(taskName, status);
        }
    }
