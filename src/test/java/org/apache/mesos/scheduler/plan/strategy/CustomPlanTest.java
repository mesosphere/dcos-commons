...
public class CustomPlanTest {
    ...
    @Test
    public void testCustomPlanFromServiceSpecDoesntThrow() throws Block.InvalidBlockException, InvalidRequirementException {
        DefaultBlockFactory blockFactory = new DefaultBlockFactory(
                mockStateStore, mockOfferRequirementProvider, mockTaskSpecificationProvider);
