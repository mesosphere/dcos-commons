...
def test_soak_upgrade_downgrade():
    sdk_versions.soak_upgrade_downgrade(PACKAGE_NAME, PACKAGE_NAME, DEFAULT_TASK_COUNT)
...
def test_soak_secrets_restart_hello0():
    ...
    sdk_cmd.run_cli('hello-world --name={} pods restart hello-0'.format(FRAMEWORK_NAME))
    sdk_cmd.run_cli('hello-world --name={} pods restart world-0'.format(FRAMEWORK_NAME))
